    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      <div className="container mx-auto px-4 py-8 space-y-8">
        <header className="relative text-center space-y-4 py-8">
          ...
          {/* Top-right Mind Map, Profile and Sign Out buttons */}
          <div className="absolute right-4 top-4 flex gap-2">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-md border border-gray-200 text-gray-700 bg-white/80 backdrop-blur hover:bg-gray-50 shadow-sm"
            >
              Profile
            </button>
            <button
              onClick={handleSignOut}
              className="px-3 py-1.5 rounded-md border border-red-200 text-red-700 bg-white/80 backdrop-blur hover:bg-red-50 shadow-sm flex items-center gap-1"
            >
